<template>
    <div>
        ...
        <div class="form-group btn-group">
            ...
            <button id="lucy" type="button" class="btn btn-primary" @click="spawnAnimals('Lucy')">Add Lucy animals</button>
            <button id="elizabeth" type="button" class="btn btn-primary" @click="spawnAnimals('Elizabeth')">Add Elizabeth animals</button>
        </div>
    </div>
</template>
