<template>
    <div>
        ...
        <h3>Conditional</h3>
        <p>Elements can be conditionally included in the DOM by using the <a href="https://vuejs.org/v2/guide/conditional.html#v-if"><code>v-if</code> directive</a>.</p>
        ...
        <h3>Lists</h3>
        <p>You can <a href="https://vuejs.org/v2/guide/list.html#Mapping-an-Array-to-Elements-with-v-for">iterate over arrays</a> or <a href="https://vuejs.org/v2/guide/list.html#v-for-with-an-Object">object properties</a> with a <code>v-for</code> loop. Make sure to use the <code>:key</code> directive to <a href="https://vuejs.org/v2/guide/list.html#Maintaining-State">maximize Vue's DOM node re-usage</a>.</p>
        <ul>
